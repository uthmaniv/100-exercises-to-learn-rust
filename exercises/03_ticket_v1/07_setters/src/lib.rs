...
impl Ticket {
    pub fn new(title: String, description: String, status: String) -> Ticket {
        Self::is_title_empty(&title);
        Self::title_range(&title);
        Self::is_description_empty(&description);
    ...
    fn description_range (description: &String) {
